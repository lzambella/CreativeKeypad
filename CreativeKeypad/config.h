...
Used for macro keypad firmware
Device has 3 rows and 6 columns of buttons
...
/*
* Luke Zambella
* TODO: Add configuration for encoders
*/

/*
* Luke Zambella
* Teensy 2.0 pin assignment
* PB0 -> Row 1
* PB1 -> Row 2
* PB2 -> Row 3
*
...
* PD3 -> Col 6
*/
// Macros to set the rows
#define R1_SET (PORTB |= (1 << 0))
#define R2_SET (PORTB |= (1 << 1))
#define R3_SET (PORTB |= (1 << 2))

// Define macros for easily reading a port pin
#define C1_READ (PORTB & (1 << 3))
#define C2_READ (PORTB & (1 << 7))
#define C3_READ (PORTD & (1 << 0))
#define C4_READ (PORTD & (1 << 1))
/*
